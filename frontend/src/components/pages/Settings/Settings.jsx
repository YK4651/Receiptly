		...
		<div className='max-w-4xl mx-auto px-4 py-2'>
			...
			<form onSubmit={handleSubmit} className='space-y-6'>
				...
				<div className='bg-white border border-gray-300 rounded-md shadow'>
					<h2 className='text-md p-6 font-light font-semibold border-b mb-4'>
						Profile Information
					</h2>
					<div className='p-6'>
              ...
              >
				...
				{/* Change Password */}
				<div className='bg-white p-6  border border-gray-300 rounded-md shadow'>
				...
				{/* Preferences */}
				<div className='bg-white p-6 rounded-md  border border-gray-300 shadow'>
